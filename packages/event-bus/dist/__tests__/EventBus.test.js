...
describe('EventBus', () => {
    it('emits and receives events', () => {
        ...
        bus.emit('task.created', { taskId: '1', title: 'Test', userId: 'u1' }, { source: 'host' });
        expect(handler).toHaveBeenCalledWith({ taskId: '1', title: 'Test', userId: 'u1' }, expect.objectContaining({ source: 'host' }));
    });
