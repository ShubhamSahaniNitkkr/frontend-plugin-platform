...
import type { MenuItemContribution, PluginManifest, PlatformEventMap, PlatformEventName, SlotId } from '@fpp/shared';
...
export interface EventAPI {
    ...
    subscribe<K extends PlatformEventName>(event: K, handler: (payload: PlatformEventMap[K]) => void): () => void;
    subscribePattern(pattern: string, handler: (event: string, payload: unknown) => void): () => void;
}
